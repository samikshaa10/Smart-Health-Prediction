...
def prediction(request):
    ...
    # Training data
    path_train = "D:\\smart-healthcare-system-master\\predict\\templates\\predict\\Training.csv"
    data_training = pd.read_csv(path_train)
    path_test = "D:\\smart-healthcare-system-master\\predict\\templates\\predict\\Testing.csv"
    ...
    symptom6 = request.GET.get("symptom6")
    ...
    symptoms.append("Symptom 1: " + symptom1)
    symptoms.append("Symptom 2: " + symptom2)
    symptoms.append("Symptom 3: " + symptom3)
    symptoms.append("Symptom 4: " + symptom4)
    symptoms.append("Symptom 5: " + symptom5)
    symptoms.append("Symptom 6: " + symptom6)
